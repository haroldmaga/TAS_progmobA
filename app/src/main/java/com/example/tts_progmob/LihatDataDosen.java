...
public class LihatDosen extends AppCompatActivity {
    ...
    private void addData(){
        ...
        dataDosenArrayList.add(new DataDosen("72160071","S.Kom", "Maguoharjo gang.nanas 6" ,"haroldmaga16@gmail.com","","Immanuel Harold Maga  "));
        dataDosenArrayList.add(new DataDosen("72160070","S.Kom","Jl.Seturan Raya", "ebenhaezer688@gmail.com","", "Eben Haezer Gultom"));
    }}
