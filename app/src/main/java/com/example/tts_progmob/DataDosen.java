        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (nama.getText().toString().length() == 0) {
                    nama.setError("ilahkan mengisi Nama Dosen");
                } else if (nidn.getText().toString().length() == 0) {
                    nidn.setError("ilahkan mengisi Nidn Dosen");
                } else if (alamat.getText().toString().length() == 0) {
                    alamat.setError("ilahkan mengisi alamat Dosen");
                } else if (email.getText().toString().length() == 0) {
                    email.setError("ilahkan mengisi Email Dosen");
                } else if (gelar.getText().toString().length() == 0) {
                    gelar.setError("ilahkan mengisi gelar Dosen");
                ...
                txtNama = findViewById(R.id.editTxtNamaDsn);
                txtNidn = findViewById(R.id.editTxtNidnDsn);
